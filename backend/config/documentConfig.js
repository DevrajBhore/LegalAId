...
const CODE_DEFINED_CONFIG = {
  ...
  IP_ASSIGNMENT_AGREEMENT: {
    ...
    sections: [
      ...
      { title: "The Assignment", fields: ["ip_types", "assigned_work_description", "contract_value", "effective_date"] },
    ],
  },
  ...
  DATA_PROCESSING_AGREEMENT: {
    ...
    sections: [
      ...
      { title: "Data Processor", fields: ["party_2_name", "party_2_address", "party_2_type"] },
      {
        ...
        fields: [
          "data_categories", "processing_purpose", "retention_period",
          "sub_processing_permitted", "cross_border_transfer",
          "breach_notification_hours", "effective_date",
        ],
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          { title: "What You Want This To Do", fields: ["protect_against", "special_terms"] },
    ],
  },
  ...
  PRIVACY_POLICY: {
    ...
    sections: [
      ...
      },
      {
        ...
        fields: ["data_categories", "processing_purpose", "retention_period"],
      },
      {
        title: "Compliance",
        fields: [
